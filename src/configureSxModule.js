define([
	...
	'fontoxml-mathml/configureAsInlineMathMlContainer',
	'fontoxml-mathml/configureAsMathMlContainer',
	'fontoxml-localization/t'
], function (
	configureAsRemoved,
	configureContextualOperations,
	configureAsInlineMathMlContainer,
	configureAsMathMlContainer,
	t
	) {
	'use strict';
	...
	return function configureSxModule (sxModule) {
		...
		configureContextualOperations(sxModule, 'self::mathml', [
			{ name: 'mathml-edit' }
		]);

		// mathml in inline layout
		configureAsInlineMathMlContainer(sxModule, 'self::mathml[fonto:in-inline-layout(.)]', t('mathematical expression'));
